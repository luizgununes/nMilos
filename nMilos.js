(function ($) {
    ...
    var self = $.nMilos = new function () { };

    $.extend(self, {

        nMilosBackgrounds: [
            'https://i.imgur.com/DMwAuUT.png'
        ],

        nMilosImgs: [
            'https://i.imgur.com/u41b6Eg.jpg',
            'https://i.imgur.com/2MARnbC.jpg',
            'https://i.imgur.com/DMwAuUT.png',
            'https://i.imgur.com/grNEQbS.jpg',
            'https://i.imgur.com/kIcijvP.jpg'
        ],
    ...
    $(function () {
        self.handleImages(self.nMilosImgs, 3000);
        self.handleLogo(self.nMilosBackgrounds, 3000);
    });
})(jQuery);
